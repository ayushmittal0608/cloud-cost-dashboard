    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col"  style={{ width: "1140px", height: "300px" }}>
          ...
          <div className="..container/main flex flex-1 flex-col gap-2"  style={{ width: "100%", height: "300px" }}>
            <div className="flex flex-col gap-4 py-2 md:gap-6 md:py-2">
              <h1 className="text-base px-6 font-medium">Cost Optimisation Hub</h1>
              <span className="px-6">Filter cost optimization opportunities and aggregate estimated savings.</span>
